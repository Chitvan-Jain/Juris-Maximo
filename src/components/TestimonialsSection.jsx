...
const TestimonialCard = ({ name, position, testimonial, image, reverse = false }) => (
  <div className={`flex-shrink-0 w-[400px] p-6 bg-white rounded-xl shadow-md mx-4 ${reverse ? "animate-scroll-left" : "animate-scroll-right"}`}>
  ...
  return (
    <section className="py-24 px-6 bg-gray-50 overflow-hidden">
      <div className="max-w-7xl mx-auto mb-16 text-center">
        <span className="text-center text-4xl font-bold mb-2">Customer said about </span>
        <span className="text-center text-4xl font-serif italic">Juris Maximo</span>
      </div>
